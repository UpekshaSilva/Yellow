                  ...
                  <div>
                    ...
                    <form action="modifyEmpF.php" method="POST" class="form-horizontal form-label-left" novalidate>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="empNo">Sup No<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="suppNo" name="supNo" class="form-control col-md-7 col-xs-12" data-validate-length-range="10" readonly="readonly" type="text" <?php echo "value='".$supNo."'>";?>
                        </div>
                      </div>
                      <div class="item form-group">
