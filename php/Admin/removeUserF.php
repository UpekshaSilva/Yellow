...
require_once '../connectionF.php';
  ...
  $sql1="SELECT Username FROM admin WHERE Emp_No LIKE '%".$empNo."%'; ";
  $result1 = mysqli_query($conn, $sql1);
  if (mysqli_num_rows($result1) > 0) {
    $sql2="DELETE FROM admin WHERE Emp_No LIKE '%".$empNo."%';";
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="removeEmpF.php" method="POST" class="form-horizontal form-label-left" novalidate>
                      <span class="section">Remove Admin</span>
