...
require_once 'connectionF.php';
  ...
  $sql="INSERT INTO admin VALUES ('$empNo','$username','$password');";
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="addAdminF.php" method="POST" class="form-horizontal form-label-left" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="password" name="password" class="form-control col-md-7 col-xs-12" data-validate-length-range="10"  required="required" type="text">
                        </div>
                      </div>
