              ...
              <div class="col-md-6 col-xs-6">
                <div class="x_panel">
                  <div>
                    ...
                    <form action="addItemF.php" method="POST" class="form-horizontal form-label-left" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="unitprice" name="unitprice" class="form-control col-md-7 col-xs-12" data-validate-length-range="10"  required="required" type="text">
                        </div>
                      </div>
