...
require_once 'connectionF.php';
  ...
  $address = '';
  $phone = '';
  $sql="SELECT Name,NIC,Address,Telephone FROM employee WHERE Emp_No LIKE '%".$empNo."%'; ";
                  ...
                  <div class="x_content">
                    ...
                    <form action="empDetailsN.php" method="POST" class="form-horizontal form-label-left" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="tel" id="telephone" name="phone" required="required" data-validate-length-range="10,12" class="form-control col-md-7 col-xs-12" <?php echo "value='".$phone."'>";?>
                        </div>
                      </div>
